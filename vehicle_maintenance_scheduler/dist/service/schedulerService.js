...
export class SchedulerService {
    ...
    constructor(evaluationApiService) {
    ...
    async buildSchedule() {
        ...
        for (const depot of depots) {
            await Log("backend", "debug", "service", `Running knapsack for depot ${depot.depotId} with mechanic hours ${depot.mechanicHours}`);
    ...
    solveKnapsack(depot, tasks) {
        ...
        void Log("backend", "debug", "service", `Knapsack result for depot ${depot.depotId}: impact=${result.totalImpact}, duration=${result.totalDuration}`);
        return result;
    }
}
