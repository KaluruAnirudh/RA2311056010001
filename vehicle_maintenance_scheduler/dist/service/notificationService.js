...
export class NotificationService {
    ...
    constructor(notificationRepository, evaluationApiService) {
    ...
    async getTopNotifications(limit) {
    ...
    normalizeExternalNotification(record) {
